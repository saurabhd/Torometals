...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		$strBlogName = ' <span class="footer-torometal">' . get_bloginfo( 'name' ) . ', LLC.</span> All rights reserved.';
		?>
		<div class="site-info">
			<?php echo ( apply_filters( 'storefront_copyright_text', $content = 'Copyright &copy; ' . date( 'Y' ) . $strBlogName ) ); ?>
			<?php echo do_shortcode("[cwa id='bespoke-footer']"); ?>
		</div><!-- .site-info -->
		<?php
	}
}
