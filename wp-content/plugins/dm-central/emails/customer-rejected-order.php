...
<!--<p><?php echo __( "We're sorry but this order has been rejected:", 'woocommerce' ); ?></p>-->
<?php $mail_bodies = get_option('imag_mall_customer_emails'); ?>
<?php echo $mail_bodies['rejected-order']; ?>
